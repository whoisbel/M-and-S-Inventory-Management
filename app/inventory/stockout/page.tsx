...
const stockout = () => {
    ...
    const headers = ["Stockout Date", "Area", "Grade", "Quantity", "Type", "Actions"]
    ...
    return <div className="h-full w-full bg-custom-white">
        <div
            className="bg-accent-gray w-full gap-2 flex items-center text-letters-color">
    ...
    swal.getHtmlContainer()!
        ...
        <option key={ind} value={date.harvestDate}>
          {date.harvestDate}
                ...
                <button className="generate-report-button mr-8">Create Stockout +</button>
