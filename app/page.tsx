                ...
                return (
                  // Parent container
                    <div className="w-full h-full flex flex-col">
                        ...
                        <div
                            className="w-full h-max bg-accent-green rounded-3xl px-4 py-2 flex flex-col flex-1">
                            <div className="w-full h-max flex justify-between items-center p-2">
                                <h1 className="font-bold text-letters-color text-[30px]">Inventory Summary</h1>
                                <button
                                    className="font-bold text-[20px] text-letters-color text-center border-[1px] border-add-minus rounded-[10px] p-4 bg-accent-gray">
                                    Generate Report
                                    +
                                </button>
